...
export default function Carousel(props) {
  ...
  function updateBackground() {
    switch (props.index) {
      case 0:
        // image from 8th slide
        props.setBgImage("mike-cox-PQBWeHKJSJI-unsplash.jpg")
        props.setProjectData({
          title: "Rubber Puckie Web App",
          githubLink: "https://github.com/Wald14/rubber-puckies-web-app",
          deployedLink: "https://rubberpuckies-0b6fa405e1f5.herokuapp.com/",
          techStack: "MERN Stack",
          description: "This was is a passion project of mine that I am continually updating. The Rubber Puckies are a beer league hockey team. This app an admin on view where the admin can log in and access their tools. These include creating and updating games, players, teams, and seasons. The web app is then dynamically updated. Users can see stats for the team, each individual player, and the stats from each game."
        })
        break;
      case 1:
    ...
    <div className="carousel">
      <div className="slider">
        ...
        <div className="slide-holder">
          ...
          {/* 1st Slide */}
          <div className="slide" style={{ transform: `translateX(${shift}%)` }} slide_index={0} slide_final_shift={0} onClick={handleSlideClick}>
            <img
          ...
          {/* 2nd Slide */}
          <div className="slide" style={{ transform: `translateX(${shift + 110}%)` }} slide_index={1} slide_final_shift={-110} onClick={handleSlideClick}>
            <img
          ...
          {/* 3rd Slide */}
          <div className="slide" style={{ transform: `translateX(${shift + 220}%)` }} slide_index={2} slide_final_shift={-220} onClick={handleSlideClick}>
            <img
          ...
          {/* 4th Slide */}
          <div className="slide" style={{ transform: `translateX(${shift + 330}%)` }} slide_index={3} slide_final_shift={-330} onClick={handleSlideClick}>
            <img
          ...
          {/* 5th Slide */}
          <div className="slide" style={{ transform: `translateX(${shift + 440}%)` }} slide_index={4} slide_final_shift={-440} onClick={handleSlideClick}>
            <img
          ...
          {/* 6th Slide */}
          <div className="slide" style={{ transform: `translateX(${shift + 550}%)` }} slide_index={5} slide_final_shift={-550} onClick={handleSlideClick}>
            <img
          ...
          {/* 7th Slide */}
          <div className="slide" style={{ transform: `translateX(${shift + 660}%)` }} slide_index={6} slide_final_shift={-660} onClick={handleSlideClick}>
            <img
          ...
          {/* 8th Slide */}
          <div className="slide" style={{ transform: `translateX(${shift + 770}%)` }} slide_index={0} slide_final_shift={0} onClick={handleSlideClick}>
            <img
              src="/assets/images/mike-cox-PQBWeHKJSJI-unsplash.jpg"
              alt=""
            />
            <h2 className="slide-title">Rubber Puckie Web App</h2>
          </div>
        </div>
