    ...
    <div className="aboutMe-page">
      ...
      <Row>
        <div className="about-me-info">
          ...
          <p>The career change to Full-stack Web Development is both nerve-racking and exciting. The University of Minnesota's Full Stack Web Development Bootcamp was a welcome challenge. I immediately fell in love with coding, especially the problem-solving aspect. In this course we started with HTML/CSS/JavaScript and worked up to producing multiple MERN stack web apps. </p>
